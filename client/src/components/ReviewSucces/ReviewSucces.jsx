...
export const ReviewSucces = ({ setOpen }) => {
  const handleClick = () => {
    setOpen(false);
  };
  return (
    <ModalContainer>
      ...
      <ReviewInfoContainer>
        ...
        <ReviewInfoDesc>
          Your comment will be published as soon as possible after being
          checked.
        </ReviewInfoDesc>
      </ReviewInfoContainer>
      <PointInfoContainer>
        <PointInfoBody>
          ...
          <PointInfo>
            <p>
              ...
              Points in your account. If your review gets 3 likes, you will get{' '}
              <span>+50</span> Points!{' '}
            </p>
          </PointInfo>
        </PointInfoBody>
