    ...
    <Container>
      ...
      <SocialPosts>
        <PostContainer>
          ...
          <LikesNComments>
            <Likes>
              <FavoriteBorder style={{ fontSize: 16, marginRight: 5 }} /> 456
            </Likes>
            <Comments>
              <ForumOutlined style={{ fontSize: 16, marginRight: 5 }} /> 65
            </Comments>
          </LikesNComments>
        </PostContainer>
        <PostContainer>
          ...
          <LikesNComments>
            <Likes>
              <FavoriteBorder style={{ fontSize: 16, marginRight: 5 }} /> 691
            </Likes>
            <Comments>
              <ForumOutlined style={{ fontSize: 16, marginRight: 5 }} /> 87
            </Comments>
          </LikesNComments>
        </PostContainer>
        <PostContainer>
          ...
          <LikesNComments>
            <Likes>
              <FavoriteBorder style={{ fontSize: 16, marginRight: 5 }} /> 508
            </Likes>
            <Comments>
              <ForumOutlined style={{ fontSize: 16, marginRight: 5 }} /> 127
            </Comments>
          </LikesNComments>
        </PostContainer>
        <PostContainer>
          ...
          <LikesNComments>
            <Likes>
              <FavoriteBorder style={{ fontSize: 16, marginRight: 5 }} /> 433
            </Likes>
            <Comments>
              <ForumOutlined style={{ fontSize: 16, marginRight: 5 }} /> 27
            </Comments>
          </LikesNComments>
        </PostContainer>
        <PostContainer>
          ...
          <LikesNComments>
            <Likes>
              <FavoriteBorder style={{ fontSize: 16, marginRight: 5 }} /> 122
            </Likes>
            <Comments>
              <ForumOutlined style={{ fontSize: 16, marginRight: 5 }} /> 55
            </Comments>
          </LikesNComments>
        </PostContainer>
      </SocialPosts>
