      ...
      <Wrapper>
        ...
        <Contacts>
          ...
          <QuestionForm>
            ...
            <Info>Use the form below to get in touch with the sales team</Info>
            <Form>
              <Input type="text" placeholder="Name *" right="17"></Input>
              <Input type="email" placeholder="Email *"></Input>
              <Input type="text" placeholder="Phone" right="17"></Input>
            ...
            <Store>
              ...
              <InfoContainer>
                <Top>
                  ...
                  <Info>
                    88 Pine St, New York, NY 10005, USA <Br />
                ...
                <Top>
                  ...
                  <Info>
                    Monday - Saturday 11am to 7pm <Br /> Sunday 11am to 6pm
                  </Info>
                </Top>
                <ViewButton
                  onClick={() => {
        ...
        <MapContainer>
          ...
          >
            <Marker longitude={-74.0061} latitude={40.7057} color="#3FB1CE" />
            <Marker longitude={-74.0122} latitude={40.7021} color="#1DC8CA" />
            <FullscreenControl />
            <NavigationControl />
          </ReactMapGL>
        </MapContainer>
